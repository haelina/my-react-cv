  ...
  return (
    <>
      <main>
        ...
        <h4>No kukas tää Hanna on?</h4>
        <p className="hometext">
          Mää oon Etelä-Pohjanmaalta lähtöisin oleva maitotilan kasvatti. Vuonna
        ...
        <h4>Työhistoria?</h4>
        <p className="hometext">
          Lapsuus ja nuoruus tuli pyörittyä luonnollisesti maitotilan töissä.
          Vuosien aikana olen ollut pariin otteeseen kaupan kassahenkilönäkin
        ...
        <p className="hometext">
          Toivoisin pääseväni hyvään työpaikkaan mukavien työkaverien
          ympäröimäksi, jotta voisin kehittää osaamistani seuraavalle tasolle.
          Etätyömahdollisuus on myös suuri plussa, sillä olen haaveillut
